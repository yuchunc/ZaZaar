defmodule ZaZaarWeb.StreamingLive.MerchModal do
  ...
  def handle_info(%{action: :new_merch} = payload, socket) do
    ...
    [merch_count] = case Transcript.get_merchandises([video_id: vid_id], get_count: true) do
      [] -> [ 0 ]
      result -> result
    end
    ...
    assigns = %{
      ...
      title: gettext("%{today} Stream #%{vid_count} Merchandise #%{merch_count}", today: today, vid_count: vid_count, merch_count: merch_count + 1),
      price: price
    }
